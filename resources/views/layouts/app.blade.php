                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <img alt="image" class="rounded-circle" src="{{asset('img/perfil/avatar.jpg')}}" width="50px" margin-top="25px" height="50px"/>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="block m-t-xs font-bold">{{Auth::user()->name}}</span>
                                <span class="text-muted text-xs block">{{Auth::user()->cargo}}<b class="caret"></b></span>
                            </a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Datos Maestros</span><span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="{{route('datosMaestros.index')}}">Referencias</a></li>
                           {{-- <li><a href="{{route('datosMaestros.generatePDF')}}">pdf</a></li>--}}

                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-flask"></i> <span class="nav-label">Producción</span><span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="{{route('produccion.index')}}">Orden de Producción</a></li>
                ...
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        ...
                        <form role="search" class="navbar-form-custom" action="search_results.html">
                            <div class="form-group">
                                <input type="text" placeholder="Buscador OP..." class="form-control"
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li style="padding: 20px">
                            <span class="m-r-sm text-muted welcome-message">Welcome to NovaSuin.</span>
                        </li>
                        <li class="dropdown">
...
@endauth
    ...
    @yield('resetPassword') {{-- form reset password --}}
   	@yield('reset') {{-- form reset password --}}
   	@yield('confirmar_password')
</body>
</html>
